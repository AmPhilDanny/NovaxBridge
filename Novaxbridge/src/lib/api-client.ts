...
export const playgroundApi = {
  list: () => get<any[]>('/academy/playground'),
  create: (data: { name: string; course_id?: string; lesson_id?: string }) => post<any>('/academy/playground', data),
  updateOpened: (id: string) => patch(`/academy/playground/${id}/opened`),
};
