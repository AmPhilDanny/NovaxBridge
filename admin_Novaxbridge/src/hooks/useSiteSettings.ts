...
const DEFAULT_CONFIG: SiteConfig = {
  brand: {
    site_name: 'Novaxbridge',
    tagline: 'Empowering the next generation of tech talent',
    logo_url: '',
    favicon_url: '',
  },
  hero: {
    badge: 'Empowering Tech Futures',
    title: 'Your Gateway to a ',
    title_highlight: 'Tech Career',
    subtitle:
      'Novaxbridge provides the intensive training, industry-recognized skills, and mentorship you need to land your dream job in the global tech economy.',
    hero_image_url:
  ...
  footer: {
    description:
      'Empowering the next generation of tech talent through intensive programs and mentorship.',
    columns: [
      {
        title: 'Programs',
        links: [
    ...
    copyright_text: '\u00A9 {year} Novaxbridge. All rights reserved.',
  },
  social: {
    twitter: '#',
    linkedin: '#',
